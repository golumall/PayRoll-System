...
{
    public partial class AdminViewSalary : System.Web.UI.Page
    {
        ...
        protected void btnsubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
              ...
              if (dr.Read())
              {
                  Response.Redirect("~/AdminSalary.aspx?email="+lblemail.Text+"&empid="+txtid.Text+"&month="+dropmonth.SelectedItem+"&year="+dropyear.SelectedItem);
              }
              else
              {
                  Response.Write("<script>alert('Related Record is not Exist..')</script>");
              }
            }
        }
